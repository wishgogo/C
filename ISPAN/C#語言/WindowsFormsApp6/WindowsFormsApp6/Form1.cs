...
namespace WindowsFormsApp6
{
    public partial class Form1 : Form
    {
        ...
        private void btnList_Click(object sender, EventArgs e)
        {
            ...
            Console.WriteLine("========修改List==========");
            myList[0] = "darkred";
            myList[2] = "deepblue";
            for(int i =0;i < myList.Count; i++) //List用Count,array用Length/GetUpperBound
            {
            ...
            myList.RemoveAt(3);
            myList.RemoveRange(4, 2);//從這個索引值4的位置移除兩個 (移除index 4和5的元素)
            foreach (string myColorString in myList)
            {
                Console.WriteLine(myColorString);
            }
            ...
            Console.WriteLine("=======================");
            Console.WriteLine("==========List轉換成 Array========");
            string[] myTempArray = myList.ToArray(); //轉成陣列0後記憶體位址不同
            //myTempArray[0]=("gray");
            ...
            //}
            Console.WriteLine("============================");
            Console.WriteLine("==========Array轉換成 List========");
            List<string> myListNew = new List<string>(myTempArray);//轉成LIST後記憶體位址不同
            foreach (string myColorString in myTempArray)
            {
                Console.WriteLine(myColorString);
            }
        ...
        private void btnArrayList_Click(object sender, EventArgs e)
        {
            ...
            myPersonInfo2.Add("0911-333-666");//index:3
            ...
            foreach (ArrayList perInfo in 員工資料集合)
            {
                ...
                double 薪資 = Convert.ToDouble(perInfo[1]);
                DateTime 到職日期 = Convert.ToDateTime(perInfo[2]);
                string 手機號碼 = Convert.ToString(perInfo[3]);
                string 地址 = Convert.ToString(perInfo[4]);
                int 年齡 = Convert.ToInt32(perInfo[5]);

                string Msg = string.Format("{0} {1} {2:D} {3} {4} {5}", 姓名, 薪資, 到職日期, 手機號碼, 地址, 年齡);
        ...
        private void btnDictionary_Click(object sender, EventArgs e)
        {
            ...
            if (dictScore.ContainsKey("陳大貓")) //查詢
            {
        ...
        private void btnHashtable_Click(object sender, EventArgs e)
        {
            ...
            Hashtable memberInfo = new Hashtable(); //物件會隨機排列
        ...
        private void btnString進階_Click(object sender, EventArgs e)
        {
            ...
            Console.WriteLine("World 第一個啟始字元Index:{0}",index);
