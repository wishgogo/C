...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //{0:F}=F預設小數後兩位=3.14 {0:1F}小數後一位=3.1 {0:2F}小數後兩位=3.14
            Console.WriteLine("小數位數 pi:{0:F}", 3.141592);
            Console.WriteLine("百分比號: {0:P}", 0.8765);
            Console.WriteLine("科學記號: {0:E}", 0.000000000001234);
            Console.WriteLine("科學記號: {0:E}", 12345000000000000.0);
            ...
            MessageBox.Show("Windows Form App 開發","標題",MessageBoxButtons.YesNoCancel,MessageBoxIcon.Warning);
        ...
        private void btnCokeClick(object sender, EventArgs e)
        {
