    ...
    class Program
    {
        ...
        { 
            ...
            for (int i = 0; i<=5; i = i + 1)
            {
                ...
                Console.WriteLine("arrayOne[{0}]取出索引值的元素內容={1}:", i ,arrayOne[i]);
            ...
            {
                Console.WriteLine("科目名稱[{0}]={1}", i, array科目名稱[i]);
            }
